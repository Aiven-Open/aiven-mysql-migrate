...
RUN wget https://github.com/mydumper/mydumper/releases/download/v1.0.0-1/mydumper_1.0.0-1.bookworm_amd64.deb
RUN apt-get install -y ./mydumper_1.0.0-1.bookworm_amd64.deb
